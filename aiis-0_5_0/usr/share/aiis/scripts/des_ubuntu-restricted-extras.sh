...
apt-get purge -q -y ttf-mscorefonts-installer
apt-get purge -q -y ubuntu-restricted-addons
apt-get purge -q -y gstreamer0.10-plugins-bad-multiverse
apt-get purge -q -y libavcodec-extra-53
apt-get purge -q -y unrar 
exit
